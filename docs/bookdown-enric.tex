...
\hypersetup{unicode=true,
            pdftitle={R \textless{}- world \#intro},
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df[df$Cromos>}\DecValTok{20}\NormalTok{,}\DecValTok{2}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{read_html}\NormalTok{(}\StringTok{"http://aquatics.cat/competicio/informacioCompeticio/2016/9/49/0"}\NormalTok{)}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(numerodehermanos >}\StringTok{ }\DecValTok{1}\NormalTok{) %>%}\StringTok{ }
\StringTok{  }\CommentTok{#creo nueva variable resultante de dividir Cromos por Edad}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{RatioCromosEdad =} \NormalTok{Cromos/Edad) %>%}\StringTok{ }
\StringTok{  }\CommentTok{#creo nueva variable (Edaden5) sumándole 5 años a la variable Edad}
\StringTok{  }\KeywordTok{transform}\NormalTok{(}\DataTypeTok{Edaden5 =} \NormalTok{Edad}\DecValTok{+5}\NormalTok{) %>%}\StringTok{ }
\StringTok{  }\CommentTok{#ordeno por numero de cromos en orden descendente}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(Cromos))%>%}\StringTok{ }
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-regli-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-regli-2.pdf}
...
\NormalTok{misdatos<-misdatos%>%}
\CommentTok{#creo la variable Es_Chica}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Es_chica=}\KeywordTok{as.numeric}\NormalTok{(Sexo==}\StringTok{"f"}\NormalTok{))}
\CommentTok{#uso geom_smooth para definir la curva de tendencia de la regresión logística}
\NormalTok{regresion_logistica<-}\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data=} \NormalTok{misdatos,}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=} \NormalTok{Cromos,}\DataTypeTok{y=} \NormalTok{Es_chica)) +}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-rlogis-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-plotseries-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-forecast-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-simpleqplot-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-qplotcolor-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-qplotfacet1-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-ggplotgeom-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-geomconstant-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-geomvariable-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-geomvariablesize-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-histogram-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-plotnetwork-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-tmapeurope-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-ggmap-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-ggmapbw-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-ggmapbcn-1.pdf}
...
\includegraphics{bookdown-enric_files/figure-latex/chunk-bcnshp-1.pdf}
